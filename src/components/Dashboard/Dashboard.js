                ...
                let data = resu.data.map((name, index) => {
                    ...
                    return (
                        <div className="customer-db-third-customerorders-detail-cont-2"
                             style={{gridTemplateColumns: "1fr 1fr 1fr 1fr", width: "80vw"}}>
            ...
            <div className={"admin-body"}>
                ...
                <div>
                    {select == 0 ? <div>
                        <div className={"scroll"}>
                            <div className={"dashboard"}>
                                ...
                                <div className="customer-db-third-customerorders-detail-cont-car"
                    ...
                    {select == 2 ? <div>
                        ...
                        <h3>Car Model ID</h3>
                        <input type={"text"} placeholder={"Insert Insurance ID"}
